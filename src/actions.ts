...
export const SET_ORIGIN_COORDINATES = 'set/originCoordinates';
export const SET_GRID_SIZE = 'set/gridSize';

export const setGridSize = (size: { width: number; height: number }) => {
  return {
    type: SET_GRID_SIZE,
    payload: size,
  }
...
export const setOriginCoordinates = (point: Point) => {
  return {
